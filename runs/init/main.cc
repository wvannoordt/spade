...
int main(int argc, char** argv)
{
    ...
    cvdf::ctrs::array<size_t, cvdf::cvdf_dim> cells_in_block(4, 4, 4);
    ...
    for (auto i: range(0,5)*grid.get_range(flow.centering, cvdf::grid::include_exchanges))
    {
        // flow(i[0], i[1], i[2], i[3], i[4]) = grid.get_block_box(i[4]).min(0);
        flow(i[0], i[1], i[2], i[3], i[4]) = i[2];
    }
