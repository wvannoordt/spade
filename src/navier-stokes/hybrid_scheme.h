...
namespace spade::convective
{
    ...
    template <typename scheme0_t, typename scheme1_t, typename blender_t, const bool full_diss_flux>
    _sp_hybrid struct hybrid_scheme_t
    {
        ...
        _sp_hybrid hybrid_scheme_t(const scheme0_t& scheme0_in, const scheme1_t& scheme1_in, const blender_t& blender_in, const hybrid_secheme_tag_t<full_diss_flux>&)
        : scheme0{scheme0_in}, scheme1{scheme1_in}, blender{blender_in} {}
        
        _sp_hybrid auto flux_designator() const { return hybrid_secheme_tag_t<full_diss_flux>(); }
